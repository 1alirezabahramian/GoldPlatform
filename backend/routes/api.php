...
Route::prefix('auth')->middleware('throttle:auth')->group(function () {
    ...
    Route::post('/staff/login', [StaffAuthController::class, 'login'])->middleware('tenant.resolve');
});
...
Route::middleware(['auth:sanctum', 'throttle:auth', 'tenant.resolve', 'tenant.user-match'])
    ->post('/auth/staff/change-password', [StaffAuthController::class, 'changePassword']);
