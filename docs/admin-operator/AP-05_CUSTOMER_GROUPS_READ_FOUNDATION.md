...
## هدف
ایجاد API فقط‌خواندنی و نسخه‌دار برای گروه‌های مشتری و سیاست معاملاتی ذخیره‌شده مرتبط، بدون تغییر هیچ قانون مالی.

## Ground Truth
- `UserGroup` دارای عنوان، اولویت، وضعیت فعال و شمارش کاربران است.
...
- users_count
- created_at
- policy ذخیره‌شده شامل فیلدهای صریح مدل، بدون metadata
